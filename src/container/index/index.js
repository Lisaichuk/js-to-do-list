export class Todo {
  ...
  static #list = []
  static #count = 0 //допоможе зберегти послідовніть чисел, не видаляючи і не переносячи наступне число та рядок на місце видаленого (якби робили через індекс, то загубилась би ця послідовність.)
  ...
  static #block = null // <main class="task__list"></main>
